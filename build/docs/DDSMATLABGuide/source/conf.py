...
project = u'Vortex OpenSplice MATLAB Guide'
...
#html_title = None
html_title = 'The Vortex OpenSplice MATLAB Guide'

# A shorter title for the navigation bar.  Default is the same as html_title.
#html_short_title = None
#html_short_title = 'HTML short Title conf.py'
html_short_title = 'OpenSplice MATLAB Guide'
...
htmlhelp_basename = 'The Vortex OpenSplice MATLAB Guide'
...
latex_documents = [('index', 'OpenSplice_DDSMATLABGuide.tex', u'DDS MATLAB Guide', u'', 'manual', True)]
...
man_pages = [('index', 'OpenSplice_DDSMATLABGuide', u'OpenSplice_DDSMATLAB Documentation', [u'ADLINK Technology Limited'], 1)]
