...
project = u'OpenSplice Deployment Guide'
...
#html_title = None
html_title = 'The OpenSplice Deployment Guide'
...
htmlhelp_basename = 'The OpenSplice Deployment Guide'
...
latex_documents = [('index', 'OpenSplice_DeploymentGuide.tex', u'Deployment Guide', u'', 'manual', True)]
...
man_pages = [('index', 'OpenSplice_Deployment_Guide', u'OpenSplice_Deployment_Guide Documentation', [u'ADLINK Technology Limited'], 1)]
