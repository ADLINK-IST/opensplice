# -*- coding: utf-8 -*-
#
# NodeJSDCPSAPIGuide build configuration file, created by
...
project = u'Node.js DCPS API Guide'
...
#html_title = None
html_title = 'Node.js DCPS API Guide'

# A shorter title for the navigation bar.  Default is the same as html_title.
#html_short_title = None
#html_short_title = 'HTML short Title conf.py'
html_short_title = 'Node.js DCPS API Guide'
...
htmlhelp_basename = 'Node.js DCPS API Guide'
...
latex_documents = [('index', 'OpenSplice_NodeJSDCPSAPIGuide.tex', u'Node.js DCPS API Guide', u'', 'manual', True)]
...
man_pages = [('index', 'OpenSplice_NodeJSDCPSAPIGuide', u'OpenSplice_NodeJSDCPSAPI Documentation', [u'ADLINK Technology Limited'], 1)]
