# -*- coding: utf-8 -*-
#
# OpenSplice Node Monitor User Guide build configuration file, created by
# ReST Editor on 08-Jun-2015
#
...
project = u'OpenSplice Node Monitor User Guide'
...
#html_title = None
html_title = 'OpenSplice Node Monitor User Guide'
...
htmlhelp_basename = 'OpenSplice_Node_Monitor_User_Guide'
...
latex_documents = [('index', 'OpenSplice_NodeMonitorGuide.tex', u'Node Monitor User Guide', u'', 'manual', True)]
# ***************
...
man_pages = [('index', 'OpenSplice_NodeMonitor_Guide', u'OpenSplice_NodeMonitor_Guide', [u'ADLINK Technology Limited'], 1)]
# * NOT TESTED
