# -*- coding: utf-8 -*-
#
# PythonDCPSAPIGuide build configuration file, created by
# ReST Editor on 28-Nov-2017
#
...
rmi_languages = 'Python'
#rmi_languages = 'Java'
rst_prolog = """
.. |rmi_langs| replace:: Python
...
project = u'Python DCPS API Guide'
...
#html_title = None
html_title = 'Python DCPS API Guide'

# A shorter title for the navigation bar.  Default is the same as html_title.
#html_short_title = None
#html_short_title = 'HTML short Title conf.py'
html_short_title = 'Python DCPS API Guide'
...
htmlhelp_basename = 'Python DCPS API Guide'
...
latex_documents = [('index', 'OpenSplice_PythonDCPSAPIGuide.tex', u'Python DCPS API Guide', u'', 'manual', True)]
...
man_pages = [('index', 'OpenSplice_PythonDCPSAPIGuide', u'OpenSplice_PythonDCPSAPI Documentation', [u'ADLINK Technology Limited'], 1)]
