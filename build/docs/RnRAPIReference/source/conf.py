# -*- coding: utf-8 -*-
#
# RnRAPIreference build configuration file, created by
# ReST Editor on 25-Sep-2015
#
...
#html_title = None
html_title = 'Vortex OpenSplice Record and Replay API Reference'

# A shorter title for the navigation bar.  Default is the same as html_title.
#html_short_title = None
#html_short_title = 'HTML short Title conf.py'
html_short_title = 'RnR API Reference'
...
htmlhelp_basename = 'Record and Replay API Reference'
...
latex_documents = [('index', 'OpenSplice_RnRAPIReference.tex', u'Vortex OpenSplice RnR API Reference', u'', 'manual', True)]
...
man_pages = [('index', 'RnR_API_Reference', u'RnR_API_Reference', [u'ADLINK Technology Limited'], 1)]
