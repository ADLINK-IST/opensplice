...
#html_title = None
html_title = 'RnR Manager User Guide'

# A shorter title for the navigation bar.  Default is the same as html_title.
#html_short_title = None
#html_short_title = 'HTML short Title conf.py'
html_short_title = 'RnR Manager Guide'
...
htmlhelp_basename = 'RnR Manager User Guide'
...
latex_documents = [('index', 'OpenSplice_RnRManagerGuide.tex', u'RnR Manager User Guide', u'', 'manual', True)]
