# -*- coding: utf-8 -*-
#
# StreamsAPIReference build configuration file, created by
# ReST Editor on 21-Oct-2015
#
...
#html_title = None
html_title = 'Streams API Reference Guide'

# A shorter title for the navigation bar.  Default is the same as html_title.
#html_short_title = None
#html_short_title = 'HTML short Title conf.py'
html_short_title = 'Streams API Reference'
...
htmlhelp_basename = 'Streams API Reference Guide'
...
latex_documents = [('index', 'OpenSplice_StreamsAPIReference.tex', u'Streams API Reference Guide', u'', 'manual', True)]
...
man_pages = [('index', 'Streams_API_Reference_Guide', u'Streams_API_Reference_Guide', [u'ADLINK Technology Limited'], 1)]
