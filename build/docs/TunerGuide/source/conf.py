# -*- coding: utf-8 -*-
#
# TunerGuide build configuration file, created by
...
latex_documents = [('index', 'OpenSplice_TunerGuide.tex', u'Tuner Guide', u'', 'manual', True)]
...
man_pages = [('index', 'Tuner_Guide', u'Tuner_Guide', [u'ADLINK Technology Limited'], 1)]
