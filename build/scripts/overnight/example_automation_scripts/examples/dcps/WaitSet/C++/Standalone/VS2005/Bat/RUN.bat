...
start /MIN startPublisher.bat pubResult.txt
call startSubscriber.bat subResult.txt
rem Checking result of subscriber
FIND /C /I "a MsgWriter joined" subResult.txt  > nul
if NOT %ERRORLEVEL%==0 GOTO Err
FIND /C /I "First Hello" subResult.txt  > nul
if NOT %ERRORLEVEL%==0 GOTO Err
FIND /C /I "Hello again" subResult.txt  > nul
if NOT %ERRORLEVEL%==0 GOTO Err
FIND /C /I "a MsgWriter lost its liveliness" subResult.txt  > nul
if NOT %ERRORLEVEL%==0 GOTO Err
FIND /C /I "escape condition triggered" subResult.txt  > nul
if NOT %ERRORLEVEL%==0 GOTO Err
echo OK
GOTO End
:Err
