...
The *Vortex OpenSplice Deployment Guide* is intended to provide a complete
reference on how to configure the OpenSplice service and tune it as required.

The *Deployment Guide* is included with the Vortex OpenSplice Documentation Set.

The *Deployment Guide* is intended to be used after reading and following the
instructions in the *Vortex OpenSplice Getting Started Guide*.

Intended Audience
*****************

The *Deployment Guide* is intended to be used by anyone who wishes to use and
configure Vortex OpenSplice.
