...
void createTopic(const char *topicName, const char *typeName)
{
   ...
   g_Topic = DDS_DomainParticipant_create_topic(g_domainParticipant, topicName, typeName, g_TopicQos, NULL, DDS_STATUS_MASK_NONE);
...
void createWriter()
{
   ...
   g_DataWriter = DDS_Publisher_create_datawriter(g_Publisher, g_Topic, g_DataWriterQos, NULL, DDS_STATUS_MASK_NONE);
...
void createReader()
{
   ...
   g_DataReader = DDS_Subscriber_create_datareader(g_Subscriber, g_Topic, g_DataReaderQos, NULL, DDS_STATUS_MASK_NONE);
