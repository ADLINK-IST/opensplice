...
{
   char* typeName = (char*) ListenerData_MsgTypeSupport_get_type_name(typeSupport);
...
void writeMessageSample(DDS_DataWriter dataWriter,
   ...
   ListenerData_Msg* messageSample)
{
   g_status = ListenerData_MsgDataWriter_write(dataWriter, messageSample, userHandle);
