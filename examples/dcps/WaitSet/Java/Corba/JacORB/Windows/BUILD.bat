...
REM
echo "Compile WaitSetData.idl with JacORB IDL Compiler"
echo === java -classpath "%JACORB_HOME%\lib\idl.jar;%JACORB_HOME%\lib\endorsed\logkit.jar;%CLASSPATH%" org.jacorb.idl.parser ../../../../../../idl/WaitSetData.idl
java -classpath "%JACORB_HOME%\lib\idl.jar;%JACORB_HOME%\lib\endorsed\logkit.jar;%CLASSPATH%" org.jacorb.idl.parser ../../../../../../idl/WaitSetData.idl
IF NOT ERRORLEVEL==0 (
  ECHO:
