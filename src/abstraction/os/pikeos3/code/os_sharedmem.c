...
/** \file os/pikeos3/code/os_sharedmem.c
 *  \brief shared memory management
 *
 * Implements shared memory management for PikeOS native by
 * including the heap implementation
 */
