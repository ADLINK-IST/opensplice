 ...
 *
 */
#ifndef OS_VXWORKS_COND_H
#define OS_VXWORKS_COND_H

#if defined (__cplusplus)
extern "C" {
#endif

#define OS_COND_MAX_NAME (12)
#define OS_COND_MAX_THREADS 16
