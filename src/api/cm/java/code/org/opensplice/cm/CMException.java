...
public class CMException extends Exception{
    ...
    private static final long  serialVersionUID = 7246004096494790422L;
    public static final String CONNECTION_LOST = "Connection with node lost or could not be opened.";
    /**
