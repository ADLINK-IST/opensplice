...
public class MetaCollection extends MetaField{
     ...
     * @param _typeName The type name of the collection.
     * @param _maxSize The maximum size of the collection.
     * @param _subType The subtype within the collection.
     */
    ...
    /**
     * Provides access to the size of a collection within this collection.
     * This can be used if the subtype of this collection also is a collection.
     * 
     * @param depth The recursive depth of the collection (0 is this collection) 
     * @return The maximum size of the collection associated with the supplied depth.
     *         If the depth is greater then the real depth, -1 is returned.
     */
