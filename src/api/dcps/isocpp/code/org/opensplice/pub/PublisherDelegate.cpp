...
PublisherDelegate::close() {
    /** @todo Properly implement close by pre-emptively releasing the Publisher resources.
    * as well as keeping track of its status.
    * Notice however that a trivial implementation  close () (like this) is
    * also compliant with the spec since resources will be collected
    * once the Publisher reference count drops to zero. */
}
...
PublisherDelegate::default_writer_qos() {
...
/** @todo OSPL-1942 implement listeners */
#ifdef _WIN32
...
void PublisherDelegate::event_forwarder (dds::pub::PublisherListener* listener,
                                        ...
                                        const dds::core::status::StatusMask& event_mask)
    {
        throw dds::core::UnsupportedError(org::opensplice::core::exception_helper(
            OSPL_CONTEXT_LITERAL("dds::core::UnsupportedError : PublisherListener is not yet implemented")));
