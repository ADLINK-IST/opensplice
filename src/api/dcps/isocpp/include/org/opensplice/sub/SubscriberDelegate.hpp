...
public:
    ...
    /**
     * This constructor constructs a delegate for the built in subscriber
     */
    SubscriberDelegate(
...
public:
    ...
    /** @todo OSPL-1944 Subscriber Listener should return list of affected DataReaders (on_data_on_readers) **/
