...
/**@brief The Qos policies for a Subscriber.
 */
public class SubscriberQos extends QosPolicy {
    private PresentationQosPolicy presentation;
    private PartitionQosPolicy partition;
    
    public SubscriberQos(PresentationQosPolicy _presentation,
    ...
    public static QosPolicy getDefault(){
        ...
        return new SubscriberQos(presentation, partition); 
    }
