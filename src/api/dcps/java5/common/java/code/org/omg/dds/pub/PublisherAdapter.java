...
/**
 * A convenience class PublisherAdapter is offered which has an empty implementation of all
 * {@link org.omg.dds.pub.PublisherListener} callback functions when the application extends from this class only the used callback
