...
/**
 * A convenience class TopicAdapter is offered which has an empty implementation of all
 * {@link org.omg.dds.topic.TopicListener} callback functions when the application extends from this class only the used callback
