...
public class ParticipantBuiltinTopicDataTypeSupport extends org.opensplice.dds.dcps.TypeSupportImpl implements ParticipantBuiltinTopicDataTypeSupportOperations
{
    private static java.lang.String idl_type_name = "DDS::ParticipantBuiltinTopicData";
    ...
    {
        super("DDS/ParticipantBuiltinTopicDataDataReaderImpl",
            "DDS/ParticipantBuiltinTopicDataDataReaderViewImpl",
            "DDS/ParticipantBuiltinTopicDataDataWriterImpl",
        ...
        if (success == 0) {
            throw Utilities.createException(
                    ...
                    "Could not allocate ParticipantBuiltinTopicDataTypeSupport." );
        }
    }
