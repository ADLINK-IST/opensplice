...
public final class PublicationMatchedStatus 
{
  ...
  public long last_subscription_handle = (long)0L;

  public PublicationMatchedStatus ()
  {
  } // ctor

  public PublicationMatchedStatus (int _total_count, int _total_count_change,int _current_count, int _current_count_change, long _last_subscription_handle)
 {
