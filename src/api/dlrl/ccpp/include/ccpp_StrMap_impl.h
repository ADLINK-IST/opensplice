 ...
 *
 */
#ifndef CCPP_STRMAP_H
#define CCPP_STRMAP_H
...
namespace DDS
{
    ...
    /**
     * <P>The StrMap is an abstract class that represents a Map that can store
     * elements identified by a String key type. The operations to store and
     ...
     * the last update round, the keys of all elements that were modified
     * during the last update round, and the keys of all elements that were
     * removed during the last update round. Changes to the map as a result of
     ...
     */
    class OS_DLRL_API StrMap_impl :
        public virtual DDS::StrMap,
        public LOCAL_REFCOUNTED_VALUEBASE
    {
        ...
        protected:
            DK_MapAdmin* map;
            StrMap_impl(DK_MapAdmin* collection);
        ...
        public:
             ...
             * This operation may only be invoked on a Collection that is
             * located in a writeable CacheAccess. A PreconditionNotMet is
             * raised otherwise.
             *
             * @param key the key that identifies the element that is to be
             * removed.
             * @throws DDS::AlreadyDeleted if the map is already deleted.
             * @throws PreconditionNotMet if the collection is not located in a
             ...
             * described case, in other situations it's
             * recommended to use this operation. When this collection belongs
             * to an ObjectRoot with read_state VOID then this operation will
             * always return a zero length sequence.
             *
             ...
             * this operation will always return a zero length sequence.
             *
