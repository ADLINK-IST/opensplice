...
#define IN_DDSI_CDR_BODY_ALIGNMENT (4U)
...
#define IN_ENTITYID_SEDP_BUILTIN_SUBSCRIPTIONS_READER      (0x000004c2)        /* Was: ENTITYID_BUILTIN_SUBSCRIPTIONS_READER */
...
#define IN_DDSI_VENDOR_PT          {0x01,0x02}
