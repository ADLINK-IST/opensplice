...
#define QP_WRITER_DATA_LIFECYCLE   (1u << 21)
#define QP_READER_DATA_LIFECYCLE   (1u << 22)
...
/* Partition QoS is not RxO according to the specification (DDS 1.2,
   ...
   matches. Same for topic and type. */
...
#define QP_CHANGEABLE_MASK (QP_USER_DATA | QP_TOPIC_DATA | QP_GROUP_DATA | QP_DEADLINE | QP_LATENCY_BUDGET | QP_OWNERSHIP_STRENGTH | QP_TIME_BASED_FILTER | QP_PARTITION | QP_TRANSPORT_PRIORITY | QP_LIFESPAN | QP_ENTITY_FACTORY | QP_WRITER_DATA_LIFECYCLE | QP_READER_DATA_LIFECYCLE)
