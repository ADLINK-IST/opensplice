...
LDLIBS		+=  $(LDLIBS_NW) -l$(DDS_USER) -l$(DDS_CONF) -l$(DDS_CONFPARSER) -l$(DDS_UTIL) -l$(DDS_KERNEL) -l$(DDS_SERIALIZATION) -l$(DDS_DATABASE) -l$(DDS_OS_NET) -l$(DDS_OS)
...
LDFLAGS         += $(SHLDFLAGS)
LDLIBS          += $(SHLDLIBS)
LDLIBS          += -l$(DDS_OS_NET) -l$(DDS_OS) -l$(DDS_DATABASE) -l$(DDS_KERNEL) -l$(DDS_USER) -l$(DDS_SERIALIZATION) $(LDLIBS_NW)
