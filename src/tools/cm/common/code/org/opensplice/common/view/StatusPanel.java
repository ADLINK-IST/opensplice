...
public class StatusPanel extends JPanel{
     ...
     * @param _defaultText The default text of the panel.
     * @param showConnectionLight Whether or not to display a connection light.
     * @param showProgressBar Whether or not to display a progressbar.
     */
    public StatusPanel(int width, String _defaultText, boolean showConnectionLight, boolean showProgressBar){
        super();
        ...
        if(showConnectionLight && showProgressBar){
            ...
            progressBar.setPreferredSize(new java.awt.Dimension(width/10 + 10,10));
            
            JPanel temp = new JPanel();
            temp.setLayout(new java.awt.BorderLayout());
            temp.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
            
            statusPanel = new JPanel();
            statusPanel.setLayout(layGridLayout2);
            statusPanel.setPreferredSize(new java.awt.Dimension(width-20-(width/10)-10,20));
            ...
            connectionPanel.setBorder(javax.swing.BorderFactory.createCompoundBorder(
                    javax.swing.BorderFactory.createCompoundBorder(
                        javax.swing.BorderFactory.createLineBorder(
                            connectionPanel.getBackground(),2), 
            ...
            statusPanel = new JPanel();
            statusPanel.setLayout(layGridLayout2);
            statusPanel.setPreferredSize(new java.awt.Dimension(width-(width/10)-10,20));
            statusPanel.setMinimumSize(new java.awt.Dimension(50,20));
            statusPanel.add(status);
            ...
            statusPanel.setPreferredSize(new java.awt.Dimension(width-20,20));
            statusPanel.setMinimumSize(new java.awt.Dimension(50,20));
            statusPanel.add(status);
     ...
     * 
     * @param connected Whether or not the application has a connection.
     * @param toolTip The tooltip that must be displayed when the user moves
     *                the mouse over the connection light.
     */
     ...
     * @param persistent Whether or not the message should never be removed or
     *                   not.
     * @param busy Whether or not the progressbar must be set in indeterminate
     *             mode or not.
     */
    public synchronized void setStatus(String msg, boolean persistent, boolean busy){
        if(msg == null){
            msg = "";
        }
...
/*
     ...
     * background color will become red and the "Error:" part of the string
     * will not be shown. If the message starts with "Warning:" the background
     * color will become yellow and the "Warning:" part of the string will not
     * be displayed. 
     * 
     * @param message The new status message.
     * @param persistent If true, the message will not be changed into
     *                   the standard text after a few seconds, but stay there 
     ...
     * 
     * @param busy When true, the progressbar will go into inderminate mode 
     */
