 ...
 */
AST_Module *
AST_Generator::create_module(UTL_ScopedName *n, const UTL_Pragmas &p)
{
...
{
   return new AST_ValueFwd (abstract, n, p);
}

/*
 * Construct an AST_StateMember node (a valuetype state member)
 */
...
{
   return new AST_StateMember (public_access, ft, n, p);
}

/*
 * Construct an AST_Initializer node (a valuetype factory initializer)
 */
AST_Initializer *AST_Generator::create_initializer
(
   UTL_ScopedName *n,
   const UTL_Pragmas &p
)
{
   return new AST_Initializer (n, p);
}

AST_BoxedValue *AST_Generator::create_boxed_valuetype
(
   UTL_ScopedName *n,
   AST_Type *t,
   const UTL_Pragmas &p
...
{
   return new AST_BoxedValue (n, t, p);
}
 ...
 */
AST_Exception *
AST_Generator::create_exception(UTL_ScopedName *n, const UTL_Pragmas &p)
{
 ...
 */
AST_Enum *
AST_Generator::create_enum(UTL_ScopedName *n, const UTL_Pragmas &p)
{
 ...
 */
AST_Field *
AST_Generator::create_field(AST_Type *ft, UTL_ScopedName *n, const UTL_Pragmas &p)
{
...
{
   return new AST_Expression((unsigned long)v);
}
 ...
 */
AST_Expression *
AST_Generator::create_expr(double d, const char * str)
{
   return new AST_Expression (d, str);
}
 ...
 */
AST_Typedef *
AST_Generator::create_typedef(AST_Type *bt, UTL_ScopedName *n, const UTL_Pragmas &p)
{
   return new AST_Typedef(bt, n, p);
}

AST_Opaque *
AST_Generator::create_opaque(UTL_ScopedName *n, const UTL_Pragmas &p)
{
   return new AST_Opaque(n, p);
}
