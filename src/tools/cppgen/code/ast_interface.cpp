...
AST_Opaque*
AST_Interface::fe_add_opaque(AST_Opaque* t)
{
   AST_Decl *d;
 ...
 */
AST_Value *AST_Interface::fe_add_valuetype(AST_Value *v)
{
   AST_Decl *predef;
   AST_Interface *fwd;
 ...
 * Add this AST_Value node (a value type declaration) to this scope
 */
AST_BoxedValue *AST_Interface::fe_add_boxed_valuetype(AST_BoxedValue *v)
{
   AST_Decl *predef;
   AST_Interface *fwd;
