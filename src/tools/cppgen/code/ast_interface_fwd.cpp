...
AST_InterfaceFwd::AST_InterfaceFwd(idl_bool local, UTL_ScopedName *n, const UTL_Pragmas &p)
      : AST_Decl(AST_Decl::NT_interface_fwd, n, p)
{
    ...
    * will fail
    */
   pd_full_definition = idl_global->gen()->create_interface(local, n, NULL, -1, p);
   /*
