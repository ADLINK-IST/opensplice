 ...
 */
UTL_StrList * AST_Operation::fe_add_context(UTL_StrList *t)
{
   pd_context = t;
   return t;
}
 ...
 *       only once..
 */
UTL_NameList * AST_Operation::fe_add_exceptions(UTL_NameList *t)
{
 ...
 */
void AST_Operation::dump(ostream &o)
{
...
AST_Type * AST_Operation::return_type()
{
   return pd_return_type;
}

AST_Operation::Flags AST_Operation::flags()
{
   return pd_flags;
}

UTL_StrList * AST_Operation::context()
{
   return pd_context;
}

UTL_ExceptList * AST_Operation::exceptions()
{
