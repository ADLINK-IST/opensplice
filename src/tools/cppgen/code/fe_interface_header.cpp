#ifdef SCCSID
static char SCCSid[] = "@(#)fe_interface_header.C 1.1   10/26/94";
#endif

#ifdef SCCSID
static char SCCSid[] = "@(#)fe_interface_header.C 1.1   9/20/94";
#endif
...
bool FE_InterfaceHeader::local ()
{
   return pd_local;
}

bool FE_InterfaceHeader::abstract ()
{
   return pd_abstract;
}
