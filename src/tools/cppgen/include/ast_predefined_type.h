...
public:
   ...
   enum PredefinedType 
   {
      ...
      , PT_wchar // Predefined type "wchar"
      ...
      , PT_object // Predefined type for "Object"
      , PT_typecode // Predefined type for "TypeCode"
      , PT_local_object // Predefined type for "LocalObject"
      , PT_unknown // Market for unknown type
   };
   ...
   // Constructor(s)
   AST_PredefinedType();
   AST_PredefinedType(PredefinedType t, UTL_ScopedName *n, const UTL_Pragmas &p);
   virtual ~AST_PredefinedType()
   {}

   // Data Accessors
   PredefinedType pt() const;
