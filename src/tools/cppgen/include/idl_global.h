...
public:
   ...
   enum ParseState {
      ...
      , PS_PragmaVersionSeen  // Need to get x.x not float!
      , PS_OpaqueDeclSeen  // Seen Opaque type declaration
      , PS_ValueForwardDeclSeen // Seen valuetype forward declaration
      , PS_BoxedValueDeclSeen // Seen boxed valuetype
      , PS_ValueInheritSpecSeen // Seen valuetype inheritance
      , PS_ValueNameSeen // Seen valuetype name
      , PS_ValueDeclSeen // Seen valuetype name
      , PS_InitializerIDSeen // Seen valuetype initializer id
      , PS_InitParDeclSeen // Seen valuetype initializer parameter
   };
   ...
   virtual const char *be();   // Get BE to use
