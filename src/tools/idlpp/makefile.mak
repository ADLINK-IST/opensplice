...
idl_base$(OBJ_POSTFIX): CFLAGS := $(filter-out $(CFLAGS_XSTRICT), $(CFLAGS)) $(CFLAGS_PERMISSIVE)
...
$(MICO_2_3_13_TMPLS): $(CCPP_TEMPLATES)
	cp $(CCPP_TEMPLATES) $(CCPP_TMPL_PATH)/DDS_Mico_2_3_13
