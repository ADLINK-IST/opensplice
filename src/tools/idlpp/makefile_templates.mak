...
MICO_2_3_13_TMPLS 	= $(foreach t, $(CCPP_TMPLS), $(addprefix $(CCPP_TMPL_PATH)/DDS_Mico_2_3_13/, $(t)))
...
ORB_TEMPLATES = $(ACE_TAO_1_4_1_TMPLS) $(MICO_2_3_11_TMPLS) $(MICO_2_3_13_TMPLS) $(EORB_3_0_TMPLS) $(OPENFUSION_1_4_1_TMPLS) $(OPENFUSION_1_5_1_TMPLS) $(OPENFUSION_1_6_1_TMPLS) $(OPENFUSION_2_TMPLS) $(SACPP_TMPLS) $(DDS_ACE_TAO_5_6_6_TMPLS)
