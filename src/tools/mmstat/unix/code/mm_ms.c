...
#define MM_MS_D_AVAILABLE_FMT           MM_MS_D_FMT_WIDTH PA_PRIdSIZE
#define MM_MS_D_USED_HDR                "D-used"
#define MM_MS_D_USED_HDR_FMT            MM_MS_D_FMT_WIDTH "s"
#define MM_MS_D_USED_FMT                MM_MS_D_FMT_WIDTH PA_PRIdSIZE
...
#define MM_MS_D_MAXUSED_FMT             MM_MS_D_FMT_WIDTH PA_PRIdSIZE
...
#define MM_MS_D_REUSABLE_FMT            MM_MS_D_FMT_WIDTH PA_PRIdSIZE
