...
static int cb_null_elem_open (void *varg, os_address parentinfo, os_address *eleminfo, const char *name)
{
    OS_UNUSED_ARG (varg);
...
static int cb_null_attr (void *varg, os_address eleminfo, const char *name, const char *value)
{
    OS_UNUSED_ARG (varg);
    OS_UNUSED_ARG (eleminfo);
    OS_UNUSED_ARG (name);
...
static int cb_null_elem_data (void *varg, os_address eleminfo, const char *data)
{
    OS_UNUSED_ARG (varg);
    OS_UNUSED_ARG (eleminfo);
    OS_UNUSED_ARG (data);
...
static int cb_null_elem_close (void *varg, os_address eleminfo)
{
    OS_UNUSED_ARG (varg);
    OS_UNUSED_ARG (eleminfo);
    return 0;
...
static int make_chars_available (struct ut_xmlpState *st, size_t nmin)
{
    ...
    if (st->cbufp + nmin > st->cbufmax && st->fp != NULL) {
...
static int parse_element (struct ut_xmlpState *st, os_address parentinfo)
{
