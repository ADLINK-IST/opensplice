namespace test.sacs
{
	...
	public class Publisher2 : Test.Framework.TestCase
	{
		/// <summary>Tests the creation and deletion of an Publisher.</summary>
		/// <remarks>Tests the creation and deletion of an Publisher.</remarks>
		public Publisher2() : base("sacs_publisher_tc2", "sacs_publisher", "publisher", "Test the creation and deletion of a Publisher."
		...
		public override Test.Framework.TestResult Run()
		{
			...
			publisher2.GetDefaultDataWriterQos(out dataWriterQosHolder);
			if (topic == null)
			{
