...
osplo_home1=~/osplo
ospli_home1=~/ospli
ospl_inst_home1=~/PrismTech/OpenSpliceDDS/V5.4.1/HDE/x86_64.linux2.6
#name of ospl release for host1
ospl_release_name1=x86_64.linux2.6-dev
ospl_start=HDE
...
osplo_home2=~/osplo
ospli_home2=~/ospli
ospl_inst_home2=~/PrismTech/OpenSpliceDDS/V5.4.1/HDE/x86.linux2.6
#name of ospl release for host2
ospl_release_name2=x86.linux2.6-dev
