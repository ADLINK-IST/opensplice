...
run_tests run_single_touchstoneSN "$(plain_hostname)" "$(plain_hostname)" "sp shm" "broadcast multicast" "1" "C C++ Java" 2>&1 | tee "$PWD/screen.log"
